...
ActiveRecord::Schema[7.2].define(version: 2024_10_24_150323) do
  ...
  create_table "specialty_doctors", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_specialty_doctors_on_doctor_id"
    t.index ["specialty_id"], name: "index_specialty_doctors_on_specialty_id"
  end
